...
use P4Pdf\Exceptions\PathException;
use P4Pdf\Exceptions\UploadException;
use P4Pdf\Lib\BaseExtraUploadParams;
use Psr\Http\Message\ResponseInterface;

/**
 * Task class
 * 
 * Base class for all PDF processing tasks.
 *
 * @package P4Pdf
 */
class Task extends P4Pdf
{
    /**
     * @var string|null  The P4PDF API Task ID.
     */
    public $task = null;
